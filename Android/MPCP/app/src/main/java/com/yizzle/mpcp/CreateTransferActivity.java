    ...
    private class FetchData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void v) {
            try {
                ...
                ArrayAdapter<CharSequence> adapter = new ArrayAdapter(CreateTransferActivity.this,
        ...
        protected void onPostExecute(Void v) {
            try {
                ...
                if(status.equals("Failure")) {
                    CreateTransferActivity.this.error(message);
                } else {
                    Intent ret = new Intent();
                    CreateTransferActivity.this.setResult(RESULT_OK, ret);
